...
- [Bi-Directional LSTM](https://github.com/tflearn/tflearn/blob/master/examples/nlp/bidirectional_rnn.py). Apply a bi-directional LSTM to IMDB sentiment dataset classification task.
