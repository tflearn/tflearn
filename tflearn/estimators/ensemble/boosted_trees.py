...
class GradientBoostedTree(BaseEstimator):
    ...
    def __init__(self, num_estimators=100, max_nodes=10000,
        ...
        super(GradientBoostedTree, self).__init__(metric=metric,
                                                  log_dir=log_dir,
...
class GradientBoostedTreeClassifier(GradientBoostedTree):
    ...
    def __init__(self, num_estimators=10, max_nodes=100,
        ...
        super(GradientBoostedTreeClassifier, self).__init__(
    ...
    def predict(self, X):
        ...
        """
        sc = super(GradientBoostedTree, self)
...
class GradientBoostedTreeRegressor(GradientBoostedTree):
    """ Random Forest Classifier.
    ...
    def __init__(self, num_estimators=10, max_nodes=100,
                 ...
                 metric=None, log_dir='/tmp/tflearn_logs/', global_step=None,
                 session=None, graph=None, name=None):
        super(GradientBoostedTreeRegressor, self).__init__(
            num_estimators=num_estimators, max_nodes=max_nodes,
